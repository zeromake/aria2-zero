...
void DHTIDCloserTest::testOperator()
{
  ...
  auto e1 = aria2::make_unique<DHTNodeLookupEntry>(std::make_shared<DHTNode>(id));
  auto ep1 = e1.get();

  id[0] = 0xb0;
  auto e2 = aria2::make_unique<DHTNodeLookupEntry>(std::make_shared<DHTNode>(id));
  auto ep2 = e2.get();

  id[0] = 0xa0;
  auto e3 = aria2::make_unique<DHTNodeLookupEntry>(std::make_shared<DHTNode>(id));
  auto ep3 = e3.get();

  id[0] = 0x80;
  auto e4 = aria2::make_unique<DHTNodeLookupEntry>(std::make_shared<DHTNode>(id));
  auto ep4 = e4.get();

  id[0] = 0x00;
  auto e5 = aria2::make_unique<DHTNodeLookupEntry>(std::make_shared<DHTNode>(id));
  auto ep5 = e5.get();
